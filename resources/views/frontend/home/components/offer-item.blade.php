        ...
        <div class="row offer_item_slider wow fadeInUp" data-wow-duration="1s">
            <div class="col-xl-4">
                <div class="fp__offer_item_single">
                    <div class="img">
                        <img src="frontend/images/slider_img_1.png" alt="offer" class="img-fluid w-100">
                    </div>
                    <div class="text">
                        <span>30% off</span>
            ...
            <div class="col-xl-4">
                <div class="fp__offer_item_single">
                    <div class="img">
                        <img src="frontend/images/slider_img_2.png" alt="offer" class="img-fluid w-100">
                    </div>
                    <div class="text">
                        <span>40% off</span>
            ...
            <div class="col-xl-4">
                <div class="fp__offer_item_single">
                    <div class="img">
                        <img src="frontend/images/slider_img_3.png" alt="offer" class="img-fluid w-100">
                    </div>
                    <div class="text">
